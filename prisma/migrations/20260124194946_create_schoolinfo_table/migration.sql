/*
  ...
  - You are about to drop the `SchoolInfo` table. If the table is not empty, all the data it contains will be lost.
...
CREATE TABLE `school_info` (
    ...
    INDEX `school_info_name_idx`(`name`),
    INDEX `school_info_admissionOpenDate_admissionCloseDate_idx`(`admissionOpenDate`, `admissionCloseDate`),
    INDEX `school_info_kcseYear_idx`(`kcseYear`),
    INDEX `school_info_totalFileCount_idx`(`totalFileCount`),
    INDEX `school_info_lastFileUpdate_idx`(`lastFileUpdate`),
    INDEX `school_info_createdAt_idx`(`createdAt`),
    INDEX `school_info_updatedAt_idx`(`updatedAt`),
    PRIMARY KEY (`id`)
