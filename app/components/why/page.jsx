...
const pathways = [
  {
    ...
    careers: [
      ...
      "Surgeon (General, Cardiac, Neuro, Orthopedic)",
      "Pediatrician",
      "Cardiologist",
      "Neurologist",
      "Dermatologist",
      ...
      // TECHNOLOGY & COMPUTING (20+ careers)
      ...
      // PHYSICAL & NATURAL SCIENCES (15+ careers)
      "Physicist",
      "Astronomer",
      "Astrophysicist",
      "Chemist (Analytical, Industrial)",
      "Biochemist",
      "Molecular Biologist",
      "Microbiologist",
      "Geneticist",
      ...
      // ARCHITECTURE & CONSTRUCTION (5+ careers)
      "Architect",
      "Landscape Architect",
      "Urban Planner",
      "Interior Designer",
  ...
  
  {
    ...
    careers: [
      ...
      // PERFORMING ARTS & MUSIC (20+ careers)
      "Music Producer",
      "Sound Engineer",
      "Film/TV Director",
      "Actor/Actress",
      ...
      // SPORTS, FITNESS & ATHLETICS (25+ careers)
      "Professional Athlete (Football, Rugby, Athletics)",
      "Sports Coach (Team/Individual)",
      ...
      "Safari Tour Guide (Sports/Adventure)",
      
      // MEDIA, JOURNALISM & DIGITAL ARTS (15+ careers)
      "Photojournalist",
      "Sports Journalist",
      "News Reporter",
      ...
      "Screenwriter",
      "Technical Writer",
      "Editor (Magazine/Newspaper)",
      "Publishing Manager",
      
      // TOURISM & HOSPITALITY (5+ careers)
      "Tour Guide",
      "Travel Agent",
  ...
  
  {
    ...
    careers: [
      ...
      // PSYCHOLOGY & COUNSELING (15+ careers)
      ...
      // SOCIOLOGY & SOCIAL WORK (15+ careers)
      "Sociologist",
      "Social Worker",
      ...
      // ECONOMICS & DEVELOPMENT (10+ careers)
      "Economist",
      ...
      // PUBLIC ADMINISTRATION (5+ careers)
      ...
      // LANGUAGES & TRANSLATION (5+ careers)
      "Translator",
      ...
      // RELIGIOUS & ETHICAL STUDIES (5+ careers)
      "Religious Leader (Pastor/Imam/Priest)",
      "Theologian",
      "Ethicist",
